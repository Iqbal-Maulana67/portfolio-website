  ...
  return (
    <section id="sectionPin">
      <div className="pin-wrap">
        <div className="w-full lg:w-2xl justify-center project-header lg:opacity-0 sm:opacity-100 text-center md:text-left mb-6 lg:mb-0">
          <h2 className="{poppins.className} text-3xl font-semibold">
            Projects
          </h2>
          <h3>Things I’ve built along the way.</h3>
        </div>
        <div className="lg:h-full sm:h-fit w-xl text-center p-5 project-container mr-5 mb-6 lg:mb-0">
          <img src="/images/valkbot.png" alt="" className="rounded-xl" />
          <h2 className="{poppins.className} text-2xl font-semibold mt-2">
            Valk Bot
          </h2>
          <h3 className="text-justify mt-2 hidden lg:block">
